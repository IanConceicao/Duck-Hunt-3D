...
export class Text_DemoNew extends Scene {             // **Text_Demo** is a scene with a cube, for demonstrating the Text_Line utility Shape.
    constructor() {
        super()
        this.shapes = {cube: new defs.Cube(), text: new Text_Line(35), min: new defs.Minimal_Shape};
    ...
    display(context, program_state ) {
        ...
        this.shapes.min.draw(context, graphics_state, model_transform, this.grey);
        this.shapes.text.set_string("line", context.context);
        this.shapes.text.draw(context, program_state, model_transform .times(Mat4.scale(.03, .03, .03)), this.text_image);
